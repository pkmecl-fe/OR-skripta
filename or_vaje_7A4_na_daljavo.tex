...
\booktitle[OSNOVE ROBOTIKE] {OSNOVE ROBOTIKE - Navodila za \\ laboratorijske vaje za delo na daljavo}
...
\\ 1. izd. - Ljubljana : \\
Laboratorij za robotiko, 2020   %letnico na prvi strani spremeni v kapmono.cls
\\ \\
...
%\include{safety}           % varnost pri delu z roboti
%\include{Matlab}
%\include{RobotStudio4}      % RobotStudio
%\include{Scara3}     % Epson vid
%\include{KUKA3}        
%\include{HC10_rob_online}
%\include{yumi_OR_online}       
%\include{DH6}             
\include{fanuc} 
